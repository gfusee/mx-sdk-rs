...
#[test]
fn buy_all_tickets_different_accounts_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_more_tickets_than_allowed_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_after_deadline_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_after_determined_winner_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_after_sold_out_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_all_options_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_another_account_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_not_on_whitelist_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_same_account_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_second_lottery_rs() -> anyhow::Result<()> {
...
#[test]
fn buy_ticket_wrong_fee_rs() -> anyhow::Result<()> {
...
#[test]
#[ignore]
fn complex_prize_distribution_rs() -> anyhow::Result<()> {
...
#[test]
fn determine_winner_different_ticket_holders_winner_acc_1_rs() -> anyhow::Result<()> {
...
#[test]
fn determine_winner_early_rs() -> anyhow::Result<()> {
...
#[test]
fn determine_winner_same_ticket_holder_rs() -> anyhow::Result<()> {
...
fn determine_winner_split_prize_pool_rs() -> anyhow::Result<()> {
    world().run("scenarios/determine-winner-split-prize-pool.scen.json")?;

    Ok(())
}
#[test]
fn lottery_init_rs() -> anyhow::Result<()> {
...
#[test]
fn lottery_with_burn_percentage_rs() -> anyhow::Result<()> {
...
#[test]
fn start_after_announced_winner_rs() -> anyhow::Result<()> {
...
#[test]
fn start_all_options_bigger_whitelist_rs() -> anyhow::Result<()> {
...
#[test]
fn start_alternative_function_name_rs() -> anyhow::Result<()> {
...
#[test]
fn start_fixed_deadline_rs() -> anyhow::Result<()> {
...
#[test]
fn start_limited_tickets_rs() -> anyhow::Result<()> {
...
#[test]
fn start_limited_tickets_and_fixed_deadline_rs() -> anyhow::Result<()> {
...
#[test]
fn start_limited_tickets_and_fixed_deadline_invalid_deadline_rs() -> anyhow::Result<()> {
...
#[test]
fn start_limited_tickets_and_fixed_deadline_invalid_ticket_price_arg_rs() -> anyhow::Result<()> {
    world().run(
...
#[test]
fn start_second_lottery_rs() -> anyhow::Result<()> {
...
#[test]
fn start_with_all_options_rs() -> anyhow::Result<()> {
...
#[test]
fn start_with_no_options_rs() -> anyhow::Result<()> {

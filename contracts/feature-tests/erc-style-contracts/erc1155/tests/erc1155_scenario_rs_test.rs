...
#[test]
fn batch_transfer_both_types_rs() -> anyhow::Result<()> {
...
#[test]
fn batch_transfer_both_types_to_sc_rs() -> anyhow::Result<()> {
...
#[test]
fn batch_transfer_fungible_rs() -> anyhow::Result<()> {
...
#[test]
fn batch_transfer_fungible_to_sc_rs() -> anyhow::Result<()> {
...
#[test]
fn batch_transfer_non_fungible_rs() -> anyhow::Result<()> {
...
#[test]
fn batch_transfer_non_fungible_to_sc_rs() -> anyhow::Result<()> {
...
// burn tests
#[test]
fn burn_fungible_rs() -> anyhow::Result<()> {
...
#[test]
fn burn_non_fungible_rs() -> anyhow::Result<()> {
...
#[test]
fn create_one_fungible_one_non_fungible_rs() -> anyhow::Result<()> {
...
// Create token tests
#[test]
fn create_token_fungible_rs() -> anyhow::Result<()> {
...
#[test]
fn create_token_non_fungible_rs() -> anyhow::Result<()> {
...
#[test]
fn create_two_tokens_both_fungible_different_creator_rs() -> anyhow::Result<()> {
...
#[test]
fn create_two_tokens_both_fungible_same_creator_rs() -> anyhow::Result<()> {
...
#[test]
fn create_two_tokens_both_non_fungible_same_creator_rs() -> anyhow::Result<()> {
...
// mint tests
#[test]
fn mint_fungible_rs() -> anyhow::Result<()> {
...
#[test]
fn mint_non_fungible_rs() -> anyhow::Result<()> {
...
#[test]
fn mint_not_creator_rs() -> anyhow::Result<()> {
...
#[test]
fn transfer_fungible_not_enough_balance_rs() -> anyhow::Result<()> {
...
#[test]
fn transfer_fungible_ok_rs() -> anyhow::Result<()> {
...
#[test]
fn transfer_fungible_ok_to_sc_rs() -> anyhow::Result<()> {
...
#[test]
fn transfer_non_fungible_ok_rs() -> anyhow::Result<()> {
...
#[test]
fn transfer_non_fungible_ok_to_sc_rs() -> anyhow::Result<()> {

...
#[test]
fn nft_approve_non_existent_token_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_approve_non_owned_token_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_approve_ok_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_mint_more_tokens_caller_not_owner_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_mint_more_tokens_receiver_acc_1_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_mint_more_tokens_receiver_owner_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_revoke_non_approved_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_revoke_ok_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_transfer_approved_token_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_transfer_non_existent_token_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_transfer_not_owned_not_approved_token_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_transfer_ok_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_transfer_token_after_revoked_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_transfer_token_not_owner_no_approval_to_caller_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_transfer_token_not_owner_no_approval_to_other_rs() -> anyhow::Result<()> {
...
#[test]
fn nft_transfer_token_ok_rs() -> anyhow::Result<()> {

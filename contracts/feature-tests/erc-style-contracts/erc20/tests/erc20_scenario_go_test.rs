...
#[test]
fn allowance_caller_caller_go() -> anyhow::Result<()> {
...
#[test]
fn allowance_caller_other_go() -> anyhow::Result<()> {
...
#[test]
fn allowance_other_caller_go() -> anyhow::Result<()> {
...
#[test]
fn allowance_other_eq_other_go() -> anyhow::Result<()> {
...
#[test]
fn allowance_other_n_eq_other_go() -> anyhow::Result<()> {
...
#[test]
fn approve_caller_positive_go() -> anyhow::Result<()> {
...
#[test]
fn approve_caller_zero_go() -> anyhow::Result<()> {
...
#[test]
fn approve_other_positive_go() -> anyhow::Result<()> {
...
#[test]
fn approve_other_zero_go() -> anyhow::Result<()> {
...
#[test]
fn approve_switch_caller_go() -> anyhow::Result<()> {
...
#[test]
fn balance_of_caller_go() -> anyhow::Result<()> {
...
#[test]
fn balance_of_non_caller_go() -> anyhow::Result<()> {
...
#[test]
fn not_payable_go() -> anyhow::Result<()> {
...
#[test]
fn not_payable_esdt_go() -> anyhow::Result<()> {
...
#[test]
fn total_supply_positive_go() -> anyhow::Result<()> {
...
#[test]
fn total_supply_zero_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_distinct_balance_eq_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_distinct_balance_n_eq_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_distinct_entire_allowance_more_than_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_distinct_entire_balance_eq_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_distinct_entire_balance_more_than_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_distinct_more_than_allowance_less_than_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_distinct_more_than_balance_less_than_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_distinct_no_overflow_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_distinct_still_no_overflow_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_equal_allowance_relevant_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_all_equal_entire_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_caller_eq_from_allowance_relevant_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_caller_eq_from_entire_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_caller_eq_from_more_than_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_caller_eq_to_balance_n_eq_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_caller_eq_to_more_than_allowance_less_than_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_caller_eq_to_more_than_balance_less_than_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_exploratory_multiple_transfers_succeed_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_exploratory_multiple_transfers_throw_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_from_eq_to_balance_eq_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_from_eq_to_balance_n_eq_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_from_eq_to_entire_allowance_more_than_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_from_eq_to_entire_balance_eq_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_from_eq_to_entire_balance_more_than_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_from_eq_to_more_than_allowance_less_than_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_from_eq_to_more_than_balance_less_than_allowance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_from_from_eq_to_no_overflow_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_caller_allowance_irrelevant_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_caller_entire_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_caller_more_than_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_caller_no_overflow_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_caller_positive_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_caller_still_no_overflow_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_caller_zero_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_other_allowance_irrelevant_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_other_entire_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_other_more_than_balance_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_other_no_overflow_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_other_positive_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_other_still_no_overflow_go() -> anyhow::Result<()> {
...
#[test]
fn transfer_other_zero_go() -> anyhow::Result<()> {

...
#[test]
fn call_value_check_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_any_1_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_any_2_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_any_3_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_any_4_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_egld_1_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_egld_2_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_egld_3_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_egld_4_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_multi_array_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_multiple_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_token_1_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_token_2_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_token_3_rs() -> anyhow::Result<()> {
...
#[test]
fn payable_token_4_rs() -> anyhow::Result<()> {
